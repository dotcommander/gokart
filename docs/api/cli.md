# Build an ecosystem-style CLI

This package remains supported for established, ecosystem-style Cobra applications. New focused CLIs generated by `gokart new` use typed Kong command structs directly.
